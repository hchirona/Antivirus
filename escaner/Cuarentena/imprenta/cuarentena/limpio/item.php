...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
 ...
 <div class="itemTools">
	<?php if($this->item->params->get('itemDateCreated')): ?>
		...
		<strong><?php echo JText::_('Post'); ?>: </strong>
		...
		<?php if($this->item->params->get('itemCategory')): ?>
			...
			<span class="itemCategory">
				<strong><?php echo JText::_('K2_IN'); ?>:</strong>
...
<div class="itemCommentText">
		<div class="commentTextHead clearfix">
	    	...
	    	<span class="commentLink">
				...
				<img src="<?php echo $comment->userImage; ?>" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" class="userAvatar" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" />
				<?php endif; ?>
